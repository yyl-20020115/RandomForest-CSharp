...
public class DecisionTree(int minSamplesSplit, int maxDepth, int maxFeatures)
{
    public DecisionNode? Root { get; private set; }
    public int MinSamplesSplit { get; private set; } = minSamplesSplit;
    public int MaxDepth { get; private set; } = maxDepth;
    public int MaxFeatures { get; private set; } = maxFeatures;

    private List<int> shuffledFeatureIndices = new List<int>();
    ...
    private (DecisionNode node, LabeledData[] left, LabeledData[] right) GetBestSplit(LabeledData[] data)
    {
        ...
        var bestNode = new DecisionNode();
        var bestLeft = Array.Empty<LabeledData>();
        var bestRight = Array.Empty<LabeledData>();
